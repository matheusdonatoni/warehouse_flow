...
final String kNowForPath = kNowToIso.replaceAll(RegExp(r'[^0-9]'), '_');
...
const String kChamberAliasQuery =
    'c.id as c_id, c.name as c_name, c.warehouseId, c.createdat as c_createdAt, c.updatedat as c_updatedAt';
const String kStreetAliasQuery =
    's.id as s_id, s.name as s_name, number, s.chamberId, s.createdat as s_createdAt, s.updatedat as s_updatedAt';
const String kPositionAliasQuery =
    'p.id as p_id, height, depth, p.streetId, p.type as p_type, p.createdat as p_createdAt, p.updatedat as p_updatedAt';
...
const String kOperationAliasQuery =
    'o.id as o_id, amount, o.type as o_type, o.chamberId, o.streetId, positionId, registerId, productId, o.createdat as o_createdAt, o.updatedat as o_updatedAt';
