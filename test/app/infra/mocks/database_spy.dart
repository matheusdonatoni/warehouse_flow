...
class DatabaseSpy extends Mock implements Database {
  ...
  void mockRawDelete(int result) =>
      this._mockRawDeleteCall().thenAnswer(
            (_) async => result,
          );
  ...
  void mockRawUpdate(int result) =>
      this._mockRawUpdateCall().thenAnswer(
            (_) async => result,
          );
  ...
  void mockRawInsert(int result) =>
      this._mockRawInsertCall().thenAnswer(
            (_) async => result,
          );
